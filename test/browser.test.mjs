...
const chrome = [process.env.CHROME_PATH, systemChrome, bundledChrome].find((candidate) => candidate && existsSync(candidate));

test("M1 页面离线生成、锁定与局部替换", { skip: !chromium || !chrome, timeout: 30000 }, async () => {
